...
namespace Slate\Metalang {
    ...
    class MetalangImplementorFunctionGraph extends MetalangFunctionGraph {
        public string $class;
        ...
        public function __construct(string $first, array $attributes, Closure $call, Closure $fallback) {
            ...
            $this->attributes = \Arr::map(
                $attributes,    
                function($attribute) {
                    return [$attribute->getTrailingAttributes(), 0];
                }
            );
        }
        ...
        public function __invoke(): mixed {
            ...
            list($match, $return) = (($next !== null ? @$this->closures[$next] : null) ?: $this->fallback)(
                ...$arguments
            );
