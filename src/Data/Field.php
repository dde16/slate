...
namespace Slate\Data {
    ...
    class Field {
        ...
        public function bool(string $errorMessage = null): static {
            return $this->cast(\Boolean::class, $errorMessage);
        }
    
        public function int(string $errorMessage = null): static {
            return $this->cast(\Integer::class, $errorMessage);
        }
    
        public function string(string $errorMessage = null): static {
            return $this->cast(\Str::class, $errorMessage);
        }
    
        public function float(string $errorMessage = null): static {
